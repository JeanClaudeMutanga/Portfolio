      ...
      <div class="container">
        ...
        <table class="table table-striped mt-5 text-muted ">
            ...
            <tbody class= "text-muted">
                <tr>
                <td scope="row"><strong>{{$product->name}}</strong></td>
                ...
                <a href="/open/{{$product->id}}" class="btn btn-success btn-sm mr-2">View</a>
                  <a href="/edit/{{$product->id}}" class="btn btn-warning btn-sm mr-2">Edit</a>
